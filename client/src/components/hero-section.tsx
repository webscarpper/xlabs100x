...
import titleLogo from "@assets/0_1750683454814.png";
      ...
      <div className="relative z-10 mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.button
            ...
            className="border-2 border-[var(--neon-green)] text-white px-6 py-3 rounded-xl font-bold text-base hover:bg-[var(--neon-green)] hover:text-crypto-black transition-all"
